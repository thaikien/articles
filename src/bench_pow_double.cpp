...
double bench_pow_3(){
    ...
    for(size_t i = 0; i < It; ++i){
        result += double(i) * double(i) * double(i);
    }
...
double bench_pow_4(){
    ...
    for(size_t i = 0; i < It; ++i){
        result += double(i) * double(i) * double(i) * double(i);
    }
...
double bench_pow_5(){
    ...
    for(size_t i = 0; i < It; ++i){
        result += double(i) * double(i) * double(i) * double(i) * double(i);
    }
